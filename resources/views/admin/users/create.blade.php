                    ...
                    <form action="{{ route('users.store') }}" method="post" >
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Nome Completo" aria-describedby="name-error" aria-invalid="true">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="{{old('email')}}" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="E-mail" aria-describedby="email-error" aria-invalid="true">
                                @error('email')
